...
public class SpawnFighters extends EnemyWave {

	boolean spawned = false;

	public SpawnFighters(EndlessLevel level) {
		super(level);
	}
	...
	public void update(float deltaTime) {
		if (!spawned) {
			...
			for (int i = 0; i < numToSpawn; i++) {
				Enemy e = new Fighter(Assets.pilot.level);
	...
	public String getDescription() {
		return "The next sector features heavily armored opponents.";
	}
